...
同样的关系对弦OA、OB也成立，上图 $ O_ {1}M_ {1} = \\frac{1}{2} N_ {1}M_ {1} = \\frac{1}{4} OM $。则 $ \\bigtrangleup O O^{\\prime}_ {1}B = \\frac{1}{4} \\bigtrangleup OBM。现在 $ \\bigtrangleup OO_ {1}A, \\bigtrangleup OO^{\\prime}_ {1}B $的面积的和为 $ T_ {1} $
